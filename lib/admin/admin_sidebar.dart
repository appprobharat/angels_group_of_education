import 'package:angels/admin/AllDue/alldue.dart';
import 'package:angels/admin/admin_dashboard.dart';
import 'package:flutter/material.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import 'package:angels/admin/Attendance/emp_attendance.dart';
import 'package:angels/admin/Receipt/list_receipt.dart';
import 'package:angels/admin/admissions/admission_list.dart';
// import 'package:angels/admin/balance_sheet/balance_sheet.dart';
import 'package:angels/admin/complaint/list_complaint.dart';
import 'package:angels/admin/day%20book/day_book.dart';
import 'package:angels/admin/employee/list_employee.dart';
import 'package:angels/admin/homeworks/manage_homework.dart';
import 'package:angels/admin/enquiry/list_enquiry.dart';
import 'package:angels/admin/alert/alert.dart';
import 'package:angels/admin/events/List_events.dart';
import 'package:angels/admin/fees/fee_due.dart';
import 'package:angels/admin/gatepass/list_gatepass.dart';
import 'package:angels/admin/income/list_income.dart';
import 'package:angels/admin/ledger/stu_ledger.dart';
import 'package:angels/admin/ledger/teacher_ledger.dart';
import 'package:angels/admin/notice/list_notice.dart';
import 'package:angels/admin/payment/list_payment.dart';
import 'package:angels/admin/result/stu_result.dart';
import 'package:angels/admin/Attendance/stu_attendance.dart';
import 'package:angels/api_service.dart';
import 'package:angels/login_page.dart';
